...
void JuceDemoPluginAudioProcessorEditor::resized()
{
    ...
    cutOffSlider.setBounds (20, 60, 150, 40);
...
void JuceDemoPluginAudioProcessorEditor::sliderValueChanged (Slider* slider)
{
    if (slider == &cutOffSlider)
    {
        ...
        /*getProcessor()->setParameterNotifyingHost (JuceDemoPluginAudioProcessor::cutOffParam,
                                                   (float) cutOffSlider.getValue());*/
		getProcessor()->setParameter(0,(float) cutOffSlider.getValue());									
    }
